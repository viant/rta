...
CREATE TABLE IF NOT EXISTS INVENTORY_127001_10000000000 (PRODUCT_ID INTEGER, NAME TEXT, QUANTITY INTEGER,PRICE FLOAT,UPDATED DATETIME, PRIMARY KEY (`PRODUCT_ID`,`NAME` ));
DELETE FROM  RTA_JN;
