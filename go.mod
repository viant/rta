...
require (
	...
	github.com/viant/parsly v0.0.0-20220627184754-7b29249ed1e8 // indirect
	github.com/viant/xunsafe v0.8.1-0.20220517184704-270ed1a5aec9 // indirect
